...
Each page stands alone and ends with the options it rejected, one line each.
...
| [**3.1 — Gold, Through Its Views Only**](/part_2/05-query-layer.md) | The three-way choice is one level too coarse |
